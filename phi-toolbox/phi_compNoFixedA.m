function [phi_star phi_star_fixed phi_MI phi_MI_fixed MI MI_fixed phi_H H_cond beta betaFixed] = phi_compNoFixedA(CovXt,CovXtXtau,CovXtau,CovXtauFixed,Z,beta_init)
